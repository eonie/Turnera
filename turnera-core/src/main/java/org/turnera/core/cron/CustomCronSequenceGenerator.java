...
public class CustomCronSequenceGenerator {
	...
	public CustomCronSequenceGenerator(String expression) {
		this(expression, TimeZone.getDefault());
	}

	public CustomCronSequenceGenerator(String expression, TimeZone timeZone) {
		this.expression = expression;
		this.timeZone = timeZone;
		parse(expression);
	}

	private CustomCronSequenceGenerator(String expression, String[] fields) {
		this.expression = expression;
		this.timeZone = null;
		doParse(fields);
	}
	...
	public static boolean isValidExpression(String expression) {
		...
		try {
			new CustomCronSequenceGenerator(expression, fields);
			return true;
		}
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof CustomCronSequenceGenerator)) {
			return false;
		}
		CustomCronSequenceGenerator otherCron = (CustomCronSequenceGenerator) other;
